...
wget https://raw.githubusercontent.com/Mykeludems/Jenkins-Maven-sonarQube-Nexus/refs/heads/main/realworld-cicd-pipeline-project-jenkins-maven-sonarqube-nexus/settings.xml -P /var/lib/jenkins/.m2/
